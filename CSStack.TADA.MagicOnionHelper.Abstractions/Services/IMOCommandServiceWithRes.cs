...
namespace CSStack.TADA.MagicOnionHelper.Abstractions
{
    ...
    [Obsolete(
        "IMOCommandServiceWithRes<TSelf, TMPReq, TReq, TMPRes, TRes> is obsolete and will be removed in a future version. Use IMOCommandService<TSelf, TMPReq, TReq, TMPRes, TRes> instead.")]
